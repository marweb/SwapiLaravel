            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="{{ url('/especie/?especie='.$people->especie) }}">{{ $people->especie }}</a></td>
                                <td class="text-center">
                            ...
                            @empty
                            <tr>
                                <td class="text-center" colspan="5">No hay informacion</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                    <div class="pagination">
                        <div class="btn-group">
                            <a href="{{ $hasPrevious }}" {{ !$hasPrevious ? 'disabled' : '' }} type="button" class="btn btn-default" >Anterior</a>
                            <a href="{{ $hasNext }}" {{ !$hasNext ? 'disabled' : '' }} type="button" class="btn btn-default">Siguiente</a>
                        </div>
                    </div>
                </div>
            </div>
